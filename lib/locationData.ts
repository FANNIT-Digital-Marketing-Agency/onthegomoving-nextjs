...
export const LOCATION_DATA: Record<string, LocationData> = {
  "seattle-movers": {
    ...
    metaTitle: "Apartment & Residential Moving in Seattle | On The Go Moving",
    ...
    intro: "Moving a high-rise apartment in South Lake Union is nothing like moving a Queen Anne craftsman — and we know the difference. On The Go Moving & Storage has been serving Seattle residents since 2009, handling everything from Capitol Hill studio apartments to Magnolia family homes. Our crews arrive prepared: elevator reservations pre-arranged, SDOT parking permits pulled, and the right truck size for your building's access requirements. You focus on your new place — we handle the logistics.",
