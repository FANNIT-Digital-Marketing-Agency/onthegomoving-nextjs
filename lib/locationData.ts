...
export const LOCATION_DATA: Record<string, LocationData> = {
  ...
  "redmond-movers": {
    ...
    faqs: [
      ...
      { q: "Where is On The Go Moving & Storage located in Redmond?", a: "Our warehouse and main office are at 14920 NE 95th St in Redmond's Willows Business Center (Redmond, WA 98052). We are centrally located in the city, which means faster response times and no travel surcharges for Redmond moves." },
