...
export const LOCATION_DATA: Record<string, LocationData> = {
  ...
  "redmond-movers": {
    ...
    metaDescription: "On The Go Moving & Storage serves Redmond, WA. Licensed & insured local movers with 4.5 stars and 497 reviews. Get a free quote today.",
    ...
    intro: "On The Go Moving & Storage is based in Redmond, WA \u2014 this is our home city. Our warehouse is right here in town, and our crews live and work in the same neighborhoods we serve. We know the traffic patterns on 520, the parking rules near Redmond Town Center, the elevator policies at Overlake's tech campus apartment buildings, and the long driveways on Education Hill. No moving company knows Redmond better.",
    localKnowledge: "Redmond is Microsoft's hometown and one of the most active moving markets on the Eastside. The Overlake neighborhood near Microsoft's campus has dense apartment complexes with strict move-in policies. Education Hill and Bear Creek feature large family homes on wooded lots with challenging access. Downtown Redmond's newer mixed-use buildings require elevator coordination. Our Redmond warehouse means we can mobilize faster than any other moving company in the city \u2014 typically arriving within 30 minutes of your scheduled start time.",
    ...
    faqs: [
      ...
      { q: "Where is On The Go Moving & Storage located in Redmond?", a: "Our warehouse and main office are at 14920 NE 95th St, Redmond, WA 98052. We are centrally located in the city, which means faster response times and no travel surcharges for Redmond moves." },
