export const SEATTLE_HOUSE_DESTINATIONS = Object.freeze({
...
export function isSeattleHouseDestinationRequest(destinationKey) {
  return typeof destinationKey === "string" && destinationKey.startsWith("seattle-house-");
}

export function applySeattleHouseDestination(lead) {
